        ...
        <div className="w-full p-8 sm:p-10 rounded-3xl bg-white border border-ayra-blush-200 shadow-xl space-y-6">
          <div className="text-center">
            ...
            <p className="font-sans text-xs text-ayra-charcoal/60 mt-1">
              Join the Ayra VIP community for bespoke gifting rewards.
            </p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4 text-xs font-sans">
            <div>
              <label className="block text-ayra-charcoal font-medium mb-1">Full Name</label>
              <div className="relative">
                <User className="w-4 h-4 text-ayra-charcoal/40 absolute left-3.5 top-1/2 -translate-y-1/2" />
                <input
                  type="text"
                  required
                  value={name}
            ...
            <div>
              <label className="block text-ayra-charcoal font-medium mb-1">Password</label>
              <div className="relative">
          ...
          <div className="text-center pt-2 border-t border-ayra-blush-100 text-xs text-ayra-charcoal/70 font-sans">
            ...
            <Link href="/auth/login" className="text-ayra-rose font-semibold hover:underline">
              Sign In
            </Link>
          </div>
        </div>
